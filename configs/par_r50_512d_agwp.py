...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--dataset',              default='cub200',   type=str,   help='Dataset to use. Currently supported: cub200, cars196, online_products, in_shop.')
    ...
    parser.add_argument('--loss',            default='proxynca',      type=str,   help='Training criteria: For supported methods, please check criteria/__init__.py')
    ...
    parser.add_argument('--arch',             default='resnet_agwp_frozen_normalize',  type=str,   help='Underlying network architecture. Frozen denotes that \
    ...
    parser.add_argument('--checkpoint_path', default="./checkpoints/agwp_r50_cub_proxyanchor.pth.tar", type=str)
    ...
    parser.add_argument('--evaluation_metrics', nargs='+', default=['e_recall@1', 'e_recall@2', 'e_recall@4', 'e_recall@8', 'mAP_c', \
