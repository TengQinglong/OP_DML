...
from ..agwp.norm_layer import LipschitzL2Normalization
from ..agwp.pdist_layer import PDistL2
from ..agwp.transport_layer import PartialTransportPlan

class AGWP(nn.Module):
    def __init__(self, in_channels, emb_dim, num_classes=512):
        super(AGWP, self).__init__()
    ...
    def gmeanp(self, features):
        ...
        x_to_p = torch.pow(x, self.power)  # x^3
